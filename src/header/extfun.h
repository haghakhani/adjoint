...
void refine_neigh_update(HashTable* El_Table, HashTable* NodeTable, int numprocs, int myid,
...
int update_topo(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid, int nump,
...
extern void Read_data(int imat, MatProps* matprops_ptr, PileProps* pileprops_ptr,
    StatProps* statprops_ptr, TimeProps* timeprops_ptr, FluxProps *fluxprops, int* adaptflag_ptr,
    int* viz_flag_ptr, int* order_flag_ptr, MapNames* mapnames_ptr, DISCHARGE* discharge_ptr,
...
extern void init_piles(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid, int numprocs,
...
void OUTPUT_ADAM_STATS(HashTable* El_Table, MatProps* matprops_ptr, TimeProps* timeprops_ptr,
...
extern void output_discharge(MatProps* matprops, TimeProps* timeprops, DISCHARGE* discharge,
    int myid);
...
void incr_tri_output(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid, int numprocs,
    MatProps* matprops, TimeProps* timeprops, double v_star);
...
void web_output(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid, double time, int numprocs,
...
void grass_sites_proc_output(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid,
    MatProps* matprops, TimeProps* timeprops);
...
//! this function is legacy, it is not defined in the finite difference/volume version of titan
extern void Assemble_bubble(int, int, int, int, double*, int*, HashTable*, HashTable*, int);

//! this function is legacy, it is not defined in the finite difference/volume version of titan
extern int make_block(int, int**, int**, int**, int**, int*, int*, HashTable*, HashTable*, int, int,
    int, int);
